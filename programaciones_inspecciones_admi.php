...
$sql0="SELECT * FROM tbl_seprr_calendario WHERE tipo = '0' AND estado<>3 $where";
				...
				<div class="content">
					...
					<div class="row">
						...
						<form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
							...
							<div class="form-group col-sm-3">
								<label for="duracion">Filtro por colaborador</label>
...
eventClick: function(eventObj) {
	if (eventObj.url) {
		alert(
			eventObj.title + '.\n' +
			'Se abriran los datos del documento'
			);
...
<?php  while ( $rslt5 = $result0 -> fetch_array(MYSQLI_ASSOC) ) { ?>

	{
		...
		"url": "datos_documento.php?id_doc="+"<?php echo $rslt5['id_doc'];?>"
	},
