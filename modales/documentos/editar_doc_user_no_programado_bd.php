...
//  función que elimina caracteres raros (comillas, puntos y comas)
    ...
    $reg_entrega = utf8_decode(mysqli_real_escape_string($mysqli, $_POST['reg_entrega'])) ;



    $sql = "UPDATE tbl_seprr_docs SET nro_doc='$nrodoc', asunto='$asunto', id_tipo_doc='$tipodoc', estado='$reg_entrega' where id='$id'";
