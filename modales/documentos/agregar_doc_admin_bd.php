...
if (!empty($_POST)){
    ...
    $sql = "INSERT INTO tbl_seprr_docs (date_recep, id_user, nro_doc, asunto, id_tipo_doc, prioridad, inspec, estado, plazo, estado_inspec, nro_doc_rpta) VALUES ('$fecha_completa', '$id_user','$nro_doc', '$asunto', '$tipo_doc', '$prioridad', '$inspeccion', '$estado_doc', '$plazo', '$estado_insp', '$nro_docu_rpta')";
    ...
    if($result){
         ...
         header('Location: ../../documentos_admin.php') ;
        
    }
    else{

         echo "Se ha producido un error". mysqli_error();
