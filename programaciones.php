...
$sql0="SELECT * FROM tbl_seprr_calendario WHERE id_user='$idUsuario' AND estado<>3 $where";
						...
						<form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
							...
							<div class="form-group col-sm-3">
								...
								<select class="form-control" id="filtro" name="filtro">
									...
									<option value="0">Inspecciones</option>
									<option value="1">Entrega docs</option>
