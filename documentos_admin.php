...
$sql2="SELECT * FROM tbl_seprr_docs ORDER BY id DESC";
...
<body>
	<div class="wrapper animsition">
												...
												<tr>
													<?php  while ( $rslt = $result2 -> fetch_array(MYSQLI_ASSOC) ) {?>
														...
														<td>
															...
															$idUsuarioconsul = utf8_encode($rslt['id_user']); 
															$sql7="SELECT tbl_users.nombres, tbl_users.apellidos FROM tbl_users WHERE id='$idUsuarioconsul'";
															$result7 = $mysqli->query($sql7);
															$row7 = $result7 -> fetch_array(MYSQLI_ASSOC);

															echo utf8_encode($row7['nombres']); 
															?>
														...
														<td align="center">
																<button class="btn btn-info btn-sm" data-placement="left" title="Ver datos" onclick="location.href='datos_documento.php?id_doc=<?php echo $id_con; ?> ';">
							...
							<div class="col-sm-12">
								<div class=" panel panel-bd">
									...
									<div class="panel-body">
										...
										<button type="button"  href="#" data-href="#" data-toggle="modal" data-target="#agregar_doc_admin" class="btn btn-labeled btn-primary m-b-5">
											<span class="btn-label"><i class="glyphicon glyphicon-plus-sign"></i></span>Asignar Documento
										</button>
										<button type="button" class="btn btn-labeled btn-primary m-b-5" onclick="location.href='asignar_reunion.php';">
											<span class="btn-label"><i class="glyphicon glyphicon-plus-sign"></i></span>Asignar Reunión
										</button>
        ...
        <?php 
        include ('modales/documentos/registrar_documento_admin.php');
