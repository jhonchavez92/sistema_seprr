    ...
    <div class="wrapper animsition">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="estado_doc" id="estado_doc" disabled="disabled">
                                                        ...
                                                        <option value="1" <?php echo $estad_docu_2;?>>En elaboración</option>
                                                        <option value="2" <?php echo $estad_docu_3;?>>Entregado</option>
                                                        <option value="3" <?php echo $estad_docu_4;?>>Finalizado</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-sm-3">
        ...
        <script>
           ...
           $(document).on("click","#editar_datos",function(){
            ...
            $('#fecha_recep').attr("disabled", false);
